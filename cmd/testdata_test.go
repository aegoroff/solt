...
const testProjectContent3a1 = `<?xml version="1.0" encoding="utf-8"?>
<Project ToolsVersion="15.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <Import Project="$(MSBuildExtensionsPath)\$(MSBuildToolsVersion)\Microsoft.Common.props" Condition="Exists('$(MSBuildExtensionsPath)\$(MSBuildToolsVersion)\Microsoft.Common.props')" />
  <PropertyGroup>
    <Configuration Condition=" '$(Configuration)' == '' ">Debug</Configuration>
  ...
  <ItemGroup>
    <Compile Include="..\a1\Program.cs">
		<Link>Program.cs</Link>
    </Compile>
    <Compile Include="..\a1\Properties\AssemblyInfo.cs">
		<Link>Properties\AssemblyInfo.cs</Link>
    </Compile>
  </ItemGroup>
  <ItemGroup>
...
const testProjectContent3a1b = `<?xml version="1.0" encoding="utf-8"?>
<Project ToolsVersion="15.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <Import Project="$(MSBuildExtensionsPath)\$(MSBuildToolsVersion)\Microsoft.Common.props" Condition="Exists('$(MSBuildExtensionsPath)\$(MSBuildToolsVersion)\Microsoft.Common.props')" />
  <PropertyGroup>
    <Configuration Condition=" '$(Configuration)' == '' ">Debug</Configuration>
  ...
  <ItemGroup>
    <Compile Include="..\a1\b\Program.cs">
		<Link>Program.cs</Link>
    </Compile>
    <Compile Include="..\a1\b\Properties\AssemblyInfo.cs">
		<Link>Properties\AssemblyInfo.cs</Link>
    </Compile>
  </ItemGroup>
  <ItemGroup>
...
const coreSolutionContent2 = `
Microsoft Visual Studio Solution File, Format Version 12.00
# Visual Studio Version 16
VisualStudioVersion = 16.0.30717.126
MinimumVisualStudioVersion = 10.0.40219.1
Project("{9A19103F-16F7-4668-BE54-9A1E7A4F7556}") = "a", "a1\a.csproj", "{836F0FC6-D6A9-4EA1-8818-35C9BD545249}"
EndProject
Project("{9A19103F-16F7-4668-BE54-9A1E7A4F7556}") = "b", "b1\b.csproj", "{295171B4-8CD0-4929-A66A-1752395121BA}"
EndProject
Project("{9A19103F-16F7-4668-BE54-9A1E7A4F7556}") = "c", "c\c.csproj", "{9C13E797-65B5-4CDA-BA15-AE260AAA23C6}"
EndProject
Project("{2150E333-8FDC-42A3-9474-1A3956D46DE8}") = "f", "f", "{97E04FD2-B904-46BE-930A-B270D264E83C}"
...
const coreTopSolutionContent = `
Microsoft Visual Studio Solution File, Format Version 12.00
# Visual Studio Version 16
VisualStudioVersion = 16.0.30717.126
MinimumVisualStudioVersion = 10.0.40219.1
Project("{9A19103F-16F7-4668-BE54-9A1E7A4F7556}") = "a", "a\a\a.csproj", "{836F0FC6-D6A9-4EA1-8818-35C9BD545249}"
EndProject
Project("{9A19103F-16F7-4668-BE54-9A1E7A4F7556}") = "b", "a\b\b.csproj", "{295171B4-8CD0-4929-A66A-1752395121BA}"
EndProject
Project("{9A19103F-16F7-4668-BE54-9A1E7A4F7556}") = "c", "a\c\c.csproj", "{9C13E797-65B5-4CDA-BA15-AE260AAA23C6}"
EndProject
Project("{2150E333-8FDC-42A3-9474-1A3956D46DE8}") = "f", "f", "{97E04FD2-B904-46BE-930A-B270D264E83C}"
EndProject
Global
...
const aSdkProjectContentFullTags = `<Project Sdk="Microsoft.NET.Sdk">
